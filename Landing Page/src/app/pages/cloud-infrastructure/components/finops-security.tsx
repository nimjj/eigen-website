    ...
    <section className="bg-white py-24 sm:py-32 relative">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 lg:items-start lg:gap-16">
          ...
          {/* Left Side: Scrollable Stack of Cards */}
          <div className="lg:col-span-7 flex flex-col gap-6 lg:order-1">

            {/* Card 1: Radical Cost Optimization */}
            <div className="group rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm ring-1 ring-zinc-200/50 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:shadow-zinc-900/5 hover:ring-zinc-300">
              ...
              <div className="mt-6 pt-6 border-t border-zinc-200 flex flex-wrap gap-2">
                <span className="rounded-full border border-zinc-200 bg-zinc-100 px-3.5 py-1 text-xs text-zinc-600">Rightsizing</span>
                <span className="rounded-full border border-zinc-200 bg-zinc-100 px-3.5 py-1 text-xs text-zinc-600">Spot Scaling</span>
                <span className="rounded-full border border-zinc-200 bg-zinc-100 px-3.5 py-1 text-xs text-zinc-600">FinOps</span>
              </div>
            </div>
            ...
            <div className="group rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm ring-1 ring-zinc-200/50 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:shadow-zinc-900/5 hover:ring-zinc-300">
              ...
              <div className="mt-6 pt-6 border-t border-zinc-200 flex flex-wrap gap-2">
                <span className="rounded-full border border-zinc-200 bg-zinc-100 px-3.5 py-1 text-xs text-zinc-600">IAM</span>
                <span className="rounded-full border border-zinc-200 bg-zinc-100 px-3.5 py-1 text-xs text-zinc-600">WAF</span>
                <span className="rounded-full border border-zinc-200 bg-zinc-100 px-3.5 py-1 text-xs text-zinc-600">KMS Encryption</span>
                <span className="rounded-full border border-zinc-200 bg-zinc-100 px-3.5 py-1 text-xs text-zinc-600">SOC2 / HIPAA</span>
              </div>
            </div>
            ...
            <div className="group rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm ring-1 ring-zinc-200/50 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:shadow-zinc-900/5 hover:ring-zinc-300">
              ...
              <div className="mt-6 pt-6 border-t border-zinc-200 flex flex-wrap gap-2">
                <span className="rounded-full border border-zinc-200 bg-zinc-100 px-3.5 py-1 text-xs text-zinc-600">CloudWatch</span>
                <span className="rounded-full border border-zinc-200 bg-zinc-100 px-3.5 py-1 text-xs text-zinc-600">Datadog</span>
                <span className="rounded-full border border-zinc-200 bg-zinc-100 px-3.5 py-1 text-xs text-zinc-600">24/7 Visibility</span>
              </div>
            </div>

          </div>

          {/* Right Side: Sticky Title & Context (Vice Versa) */}
          <div className="lg:col-span-5 lg:sticky lg:top-48 h-fit mb-12 lg:mb-0 lg:order-2">
