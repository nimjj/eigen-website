    ...
    <section className="bg-zinc-50 py-24 sm:py-32 overflow-hidden border-t border-zinc-200/50">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative h-[280px] w-full flex items-center justify-center rounded-3xl bg-white shadow-sm ring-1 ring-zinc-200/50">
            {/* Center Node (AI Octopus Head) */}
            <div className="absolute top-[20%] left-[50%] -translate-x-1/2 -translate-y-1/2 z-20 flex h-16 w-16 items-center justify-center rounded-2xl bg-[var(--accent-yellow)] shadow-lg shadow-[var(--accent-yellow)]/20">
              <Bot className="h-8 w-8 text-zinc-900" />
            </div>

            {/* Connecting Lines (SVG) - Bent Pipe lines */}
            <svg className="absolute inset-0 h-full w-full pointer-events-none" xmlns="http://www.w3.org/2000/svg">
              <g stroke="currentColor" strokeWidth="3" fill="none" strokeLinejoin="round" className="text-zinc-200">
                {/* Lines from AI head (50%, 20%) to nodes at 80% height */}
                <path d="M 50% 20% L 50% 50% L 10% 50% L 10% 80%" />
                <path d="M 50% 20% L 50% 50% L 30% 50% L 30% 80%" />
                <path d="M 50% 20% L 50% 80%" />
                <path d="M 50% 20% L 50% 50% L 70% 50% L 70% 80%" />
                <path d="M 50% 20% L 50% 50% L 90% 50% L 90% 80%" />
              </g>
            </svg>

            {/* Surrounding Nodes */}
            {/* S3 */}
            <div className="absolute top-[80%] left-[10%] -translate-x-1/2 -translate-y-1/2 z-10 flex h-12 w-12 flex-col items-center justify-center rounded-xl bg-zinc-50 border border-zinc-200 shadow-sm gap-1">
            ...
            {/* Salesforce */}
            <div className="absolute top-[80%] left-[30%] -translate-x-1/2 -translate-y-1/2 z-10 flex h-12 w-12 flex-col items-center justify-center rounded-xl bg-zinc-50 border border-zinc-200 shadow-sm gap-1">
            ...
            {/* Jira */}
            <div className="absolute top-[80%] left-[50%] -translate-x-1/2 -translate-y-1/2 z-10 flex h-12 w-12 flex-col items-center justify-center rounded-xl bg-zinc-50 border border-zinc-200 shadow-sm gap-1">
              <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none">
            ...
            {/* Google Sheets */}
            <div className="absolute top-[80%] left-[70%] -translate-x-1/2 -translate-y-1/2 z-10 flex h-12 w-12 flex-col items-center justify-center rounded-xl bg-zinc-50 border border-zinc-200 shadow-sm gap-1">
              <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none">
            ...
            {/* EHR */}
            <div className="absolute top-[80%] left-[90%] -translate-x-1/2 -translate-y-1/2 z-10 flex h-12 w-12 flex-col items-center justify-center rounded-xl bg-zinc-50 border border-zinc-200 shadow-sm gap-1">
              <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none">
